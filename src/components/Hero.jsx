    ...
    <Container className="pb-8 pt-20 text-center lg:pt-32">
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
        ...
        <span className="relative whitespace-nowrap text-blue-600">
          ...
          <span className="relative">Gall-E</span>
        </span>{" "}
      </h1>
      <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-600">
        The assistant to help citizens navigate bureaucracy
      </p>

      <div className="mt-10 flex justify-center gap-x-6"></div>
      <div className="mt-36 lg:mt-44">
        <div className="align-bottom">
          <p className="inline h-6 text-nowrap align-bottom font-semibold text-slate-700">
            Made in Switzerland
          </p>
          <Image
