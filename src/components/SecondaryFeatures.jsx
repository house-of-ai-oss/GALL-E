...
const features = [
  ...
  },
  {
    ...
    summary: "Quantify Success",
    description:
      "Evaluate the assistant's contribution to your service team by tracking call resolution times, agent assistance, and overall efficiency gains",
