...
const features = [
    {
        title: 'Save Human Time',
        description:
            "Keep track of everyone's calls, as well as Call Volume Metrics, Call Resolution Metrics, Caller Satisfaction Metrics, Knowledge Base Utilization Metrics",
        image: screenshotDashboard,
    },
    {
        title: 'Automated Triaging',
        description:
            'Classify calls with custom label policies, to assign tickets to the right people for the right actions.',
        image: screenshotLabels,
    },
    {
        title: 'Ticket Generation',
        description:
            'Automatically generates tickets from handled calls, that need human help.',
        image: screenshotTickets,
    },
    {
        title: 'Comprehensive Knowledge Base',
        description: 'Automatically scraping and indexing 8458 webpages at https://www.sg.ch/',
            ...
            <Container className="relative">
                <div className="max-w-2xl md:mx-auto md:text-center xl:max-w-none">
                    <h2 className="font-display text-3xl tracking-tight text-white sm:text-4xl md:text-5xl">
                        Voice AI for St. Gallen Government
                    </h2>
                    <p className="mt-6 text-lg tracking-tight text-blue-100">
                        See how you can help your citizens most efficiently.
                    </p>
                </div>
                <Tab.Group
                    as="div"
